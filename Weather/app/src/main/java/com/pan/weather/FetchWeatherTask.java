...
public class FetchWeatherTask extends AsyncTask<String, Void, Void> {
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        Cursor c = mContext.getContentResolver().query(LocationEntry.CONTENT_URI,
        ...
        long location_ID = -1;
        if(c.moveToFirst()) {
            location_ID= c.getLong(c.getColumnIndex(LocationEntry._ID));
        }
        else {
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            for(int i = 0; i < weatherArray.length(); i++) {
                ...
                weatherValues.put(WeatherEntry.COLUMN_WEATHER_CONDITION_ICON, icon);
            ...
            if ( cVVector.size() > 0 ) {
                ...
                cVVector.toArray(a);
                inserted = mContext.getContentResolver().bulkInsert(WeatherEntry.CONTENT_URI, a);
            }
